...
export default function Tracker() {
  ...
  const t = translation[lang]["/tracker"] || translation.en["/tracker"];
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="stat-card bg-white p-6 rounded-2xl shadow-lg border-t-4 border-red-500 text-center">
          <h2 className="text-lg font-semibold text-gray-600">{t.pending}</h2>
        ...
        <div className="stat-card bg-white p-6 rounded-2xl shadow-lg border-t-4 border-yellow-500 text-center">
          <h2 className="text-lg font-semibold text-gray-600">{t.progress}</h2>
        ...
        <div className="stat-card bg-white p-6 rounded-2xl shadow-lg border-t-4 border-green-500 text-center">
          <h2 className="text-lg font-semibold text-gray-600">{t.completed}</h2>
      ...
      {/* Issue List */}
      <h2 className="text-2xl font-bold text-gray-800 mb-4">{t.reported}</h2>
      ...
      {/* Activity Feed */}
      <h2 className="text-2xl font-bold text-gray-800 mb-4">{t.recent}</h2>
